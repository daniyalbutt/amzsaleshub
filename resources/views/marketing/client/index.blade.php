                    ...
                    <table class="display table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="btn btn-secondary btn-sm">{{ $datas->added_by != null ? $datas->added_by->name . ' ' . $datas->added_by->last_name : '' }}</span></td>
                                <td><span class="btn btn-dark btn-sm">{{ $datas->getSource() }}</span></td>
                                <td>
                                    @if($datas->status == 1)
