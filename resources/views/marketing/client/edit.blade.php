                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group mb-3">
                                    <label for="client_source">Source <span>*</span></label>
                                    <select name="client_source" id="client_source" class="form-control" required>
                                        <option value="">Select Source</option>
                                        <option value="0" {{ $data->client_source == 0 ? 'selected' : '' }}>PPC</option>
                                        <option value="1" {{ $data->client_source == 1 ? 'selected' : '' }}>TT</option>
                                        <option value="2" {{ $data->client_source == 2 ? 'selected' : '' }}>SMM</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
