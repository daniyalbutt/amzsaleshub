    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form class="form" action="{{route('marketing.invoice.update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group mb-3">
                                ...
                                <select class="form-control" name="sale_type" id="sale_type" required>
                                    ...
                                    <option value="1" {{ $invoice->sale_type == 1 ? 'selected' : '' }}>Front</option>
                                    <option value="2" {{ $invoice->sale_type == 2 ? 'selected' : '' }}>Upsell</option>
                                    <option value="3" {{ $invoice->sale_type == 3 ? 'selected' : '' }}>Remaining</option>
                                </select>
                            </div>
                            <div class="col-md-3 form-group mb-3">
