    ...
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            <li class="nav-item {{ (request()->routeIs('marketing.home'))? 'active' : '' }}">
                <a class="nav-item-hold" href="{{ route('marketing.home') }}">
            ...
            <li class="nav-item {{ (request()->routeIs('sale.invoice')) || (request()->routeIs('sale.single.invoice') || request()->routeIs('marketing.link')) ? 'active' : '' }}">
            ...
            <li class="nav-item {{ (request()->routeIs('spending.index')) || (request()->routeIs('spending.create') || request()->routeIs('spending.edit')) ? 'active' : '' }}">
                <a class="nav-item-hold" href="{{ route('spending.index') }}">
                    <i class="nav-icon i-Dollar-Sign"></i>
                    <span class="nav-text">Spending</span>
                </a>
                <div class="triangle"></div>
            </li>
        </ul>
